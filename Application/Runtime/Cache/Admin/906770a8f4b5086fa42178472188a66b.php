			...
			<div class="container-fluid">
				<div class="row-fluid">
					...
					<div class="btn-toolbar">
						<a class="btn btn-danger pull-right" onclick="resetAudit('kg_flag','审核中')">
							撤销审核
						</a> 
						<form class="form-inline" id="form1" action="/grid_chi/index.php/Admin/Project/auditKgProjectMain" method="get">
						...
						<?php if(empty($list)): ?><tr>
							<td colspan="20" align="center"><font color="red">查无数据</font></td>
								...
								<?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr id="<?php echo ($vo["id"]); ?>"<?php if(($k%2) == "0"): ?>class="odd"
										...
										<td>
											<a href="/grid_chi/index.php/Admin/Project/auditKgProjectUI?id=<?php echo ($vo["id"]); ?>&flag=<?php echo ($flag); ?>&add_dept=<?php echo ($add_dept); ?>&s_date=<?php echo ($s_date); ?>&e_date=<?php echo ($e_date); ?>"><?php if(($vo["qy_total_invest"]) >= "5"): ?><img src="/grid_chi/Public/images/icon/flag.png"/><?php endif; ?>
										...
										<td><font color="red"><?php echo ($vo['kg_status']!='已开工'?'error':''); echo ($vo["kg_flag"]); ?></font></td>
										<td>
										...
										<td>
										    ...
										    <?php if(($vo["kg_flag"]) == "审核中"): ?><a href="/grid_chi/index.php/Admin/Project/auditKgProjectUI?id=<?php echo ($vo["id"]); ?>">审核</a><?php endif; ?>
										</td> -->
