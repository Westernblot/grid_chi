	...
	<script type="text/javascript">
	   ...
	   function doQuery(){
	   	    ...
	   	    var kg_flag  = $('#kg_flag').val();
	   	 	location.href = '/grid_chi/index.php/Admin/Project/kgProjectMain?zc_hs_name=' + zc_hs_name + "&kg_flag=" + kg_flag;
	   } 
		//删除
		function doDelete() {
			var ids = getId('delete');
			...
			<div class="container-fluid">
				<div class="row-fluid">
					...
					<div class="btn-toolbar"><form class="form-inline">
						...
						<p>
							<a href="/grid_chi/index.php/Admin/Project/kgProjectUI" class="btn btn-primary"><img src="/grid_chi/Public/images/icon/plus.png"/> 添加项目</a>　　
						    <a href="javascript:updateAudit('kg_flag','审核中')" class="btn btn-info"> 提交审核</a>
							<a href="javascript:updateAudit('kg_flag','已保存')" class="btn"> 撤销提交</a>
						</p>
						...
						<?php if(empty($list)): ?><tr>
							<td colspan="20" align="center"><font color="red">查无数据</font></td>
								...
								<?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr id="<?php echo ($vo["id"]); ?>" <?php if(($k%2) == "0"): ?>class="odd"
										...
										<td>
											  <?php if(($vo["kg_flag"]) != "审核通过"): ?><input type="checkbox" name="chk" id="chk"><?php endif; ?>
										</td>
										...
										<td><font color="red"><?php echo ($vo["kg_flag"]); echo ($vo['kg_status']!='已开工'?'error':''); ?></font></td>
										<td>
											<a href="/grid_chi/index.php/Admin/Project/seeProjectUI?id=<?php echo ($vo["id"]); ?>&showNum=4">查看</a></td>
										<td>
											<?php if(($vo["kg_flag"]) != "审核通过"): ?><a href="/grid_chi/index.php/Admin/Project/kgProjectUI?id=<?php echo ($vo["id"]); ?>">编辑</a></td><?php endif; ?>
											<!-- <a href="/grid_chi/index.php/Admin/Project/tcProjectUI?id=<?php echo ($vo["id"]); ?>&toPage=kgProjectMain">变更投产项目</a> -->
										</td>
										<td>
											   <?php if(($vo["kg_flag"]) == "审核通过"): if(($vo["tc_status"]) != "已投产"): ?><a href="/grid_chi/index.php/Admin/Project/tcProjectUI?id=<?php echo ($vo["id"]); ?>">提交到投产项目</a><?php endif; endif; ?>
										</td>
